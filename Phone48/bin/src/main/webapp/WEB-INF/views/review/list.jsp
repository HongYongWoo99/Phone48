	...
	<section>
		...
		<div class="grade_container">
			...
			<div class="txt_score">
				<p>
					현재
					<%--  ${sessionScope.client.id } --%>
					님의 리뷰 점수 : ${sessionScope.list.review_point}
				</p>
			</div>
				...
				<table class="table-striped">
					...
					<tr>
						<td colspan="7"><c:if
								...
								<a
									href="reviewList.do?pageNo=${requestScope.pagging.startPageOfPageGroup-1 }"></a>
								...
								<a
									href="reviewList.do?pageNo=${requestScope.pagging.endPageOfPageGroup+1 }">>></a>
							</c:if></td>
					</tr>
					<tr>
						<td colspan="7" class="btn"><a href="reviewWriteView.do">글쓰기</a>
						</td>
					</tr>
				</table>
			</div>
