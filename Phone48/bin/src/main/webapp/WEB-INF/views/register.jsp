		...
		<div class="register_container">
			...
			<table class="register_table">
				<tr>
					...
					<td colspan="2"><button id="id_double_check_btn">중복확인</button></td>
				</tr>
				<tr>
					<td colspan="2" class="register_txt">비밀번호</td>
					<td colspan="6"><input type="password" id="pass"
						placeholder="6~20자의 영문/숫자/특수문자"></td>
					<td colspan="2"></td>
				</tr>
				<tr>
					<td colspan="2" class="register_txt">비밀번호 확인</td>
					<td colspan="6"><input type="password" id="pass_check"
						placeholder="비밀번호 한번 더 입력"></td>
					<td colspan="2"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="6"><input type="text" id="nickname"
						placeholder="별칭을 입력해주세요"></td>
					<td colspan="2"><button id="nickname_double_check_btn">중복확인</button></td>
				</tr>
				<tr>
					<td colspan="2" class="register_txt">이메일</td>
					<td colspan="3"><input type="text" id="nickname"
						placeholder="이메일"></td>
					<td colspan="1" class="email">@</td>
					<td colspan="4"><select name="email_sel" id="email_sel">
				...
				<tr>
					...
					<td colspan="1"><select name="tel_sel" id="tel_sel">
