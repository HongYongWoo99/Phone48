	...
	<section>
		...
		<article>
			...
			<form action="memberUpdate.do">
				<input type="text" name="id" value="${sessionScope.client.id }"
					readonly>
				<p class="pass">
					비밀번호 <input type="password" name="pass"
						placeholder="6~20자의 영문/숫자/특수문자">
				</p>
				<p class="passcheck">
					비밀번호 확인 <input type="password" name="passcheck"
				...
				<p class="nickname">
					닉네임 <input type="text" name="nickname" placeholder="별칭을 입력해주세요">
					<button type="submit" name="">중복확인</button>
				</p>
				<p class="email">
					이메일 <input type="email" name="email" placeholder="이메일">@ <select
						name="mail" id="mail">
						<option>naver</option>
						<option>gmail</option>
						<option>daum</option>
				...
				<p class="tel">
					전화번호 <select name="tel" id="tel">
						<option>010</option>
						<option>011</option>
						<option>018</option>
						<option>직접입력</option>
					</select> <input type="text" name="tel_num" placeholder="- 제외하고 입력해주세요">
				</p>
				<p class="address">
					주소 <input type="text" name="place">
					<button type="submit">주소검색</button>
				</p>
				<input type="text" name="address" class="detail"
