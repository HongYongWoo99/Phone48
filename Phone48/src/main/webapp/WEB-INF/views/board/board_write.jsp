			...
			<div class="member_info">
				...
				<table class="minfo">
					<tr>
						...
						<th>판매취소</th>
						<td><input type="hidden" name="scancel"></td>
					</tr>
					<tr>
						<th>가입일자</th>
						<td><input type="hidden" name="date"></td>
						<th>거래완료</th>
						<td><input type="hidden" name="dealsuccess"></td>
						<th>구매취소</th>
						<td><input type="hidden" name="bcancel"></td>
					</tr>
					<tr>
						<th>회원등급</th>
						<td><input type="hidden" name="grade"></td>
						<th></th>
						<td><input type="hidden"></td>
						<th>반품</th>
						<td><input type="hidden" name="return"></td>
					</tr>
