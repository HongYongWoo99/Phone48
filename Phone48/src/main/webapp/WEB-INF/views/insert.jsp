        ...
        <div class="container">
            <form action="/insertProc" method="post">
                <table class="board" >
                    ...
                    <tbody>
                        <tr>
                            <td> <select name="#" id="buy_list">
								<option value="1"> </option>
                            </select><input type="text" class="form-control-1" placeholder="구매내역 조회" id="title" name="title"  > </td>
                        </tr>
                        <tr>
                            <td> <textarea class="form-control" placeholder="글 내용" id="content"name="content" maxlength="2000" style="height:350px;" ></textarea> </td>
                        </tr>
                    </tbody>
                    <tr>
                    </tr>
